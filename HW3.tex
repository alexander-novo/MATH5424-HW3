...
\begin{enumerate}[leftmargin=\labelsep]
	...
	\item (From Golub and van Loan) Given \(\mat{A} \in \reals^{m \times n}\), let \(\sigma_1\) denote the largest singular value of \(\mat{A}\). Prove that
	      ...
	      \begin{proof}
		      ...
		      \end{equation}
		      which is the inner product, or the projection of a unit vector \(\frac{\vec{y}}{\norm{\vec{y}}_2}\) onto \(\frac{\mat{A}\vec{x}}{\norm{\vec{x}}_2}\). The maximum of this quantity is achieved when \(\frac{\vec{y}}{\norm{\vec{y}}_2}\) is the unit vector in the direction of \(\frac{\mat{A}\vec{x}}{\norm{\vec{x}}_2}\). In other words,
		      \begin{align*}
			      \frac{\vec{y}}{\norm{\vec{y}}_2} & = \frac{\displaystyle\frac{\mat{A}\vec{x}}{\norm{\vec{x}}}_2}{\norm{\displaystyle\frac{\mat{A}\vec{x}}{\norm{\vec{x}}_2}}_2} \\
			                                       & = \frac{\mat{A}\vec{x}}{\norm{\mat{A}\vec{x}}_2}.
		      \end{align*}
